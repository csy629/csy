<template>
  <div class="app-container">
    ...
    <div class="filter-container flex j-between">
      <h2 style="margin: 0">移动端官网Banner管理</h2>
      <div>
    ...
    <el-table
      ...
      <el-table-column width="300px" align="center" label="缩略图">
        <template slot-scope="scope">
...
<script>
  import { getWebSiteBannerDetail, createBannner, saveWebSiteBanner, editWebSiteBannerStatus ,updateBannnerSort } from '@/api/MobileBannerManage'
